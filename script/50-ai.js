...
//         this.#neuralNetSrv = new NeuralNetSrv(aiConfig);
//         this.bindEvents();
...
//                 this.#generation.push(this.#neuralNetSrv.clone(this.#ancestorModel));
//         } else {
//             for (let i = 0; i < this.#population; i++)
//                 this.#generation.push(this.#neuralNetSrv.create());
//         }
...
//         let mutants = toMutate.map(m => this.#neuralNetSrv.mutate(m));
